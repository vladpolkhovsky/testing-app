    ...
    <LiquidGlass class="w-full m-3 xm:w-3xl p-5">
      ...
      <div class="mt-3 p-5 flex flex-col justify-start gap-3">
        ...
        <div class="flex items-center gap-5" v-for="elem in registry">
          <a :href="`/api/quiz/editor/${elem.id}/start`" target="_blank"><CirclePlay :size="64" class="p-3 shadow rounded-xl hover:bg-emerald-700/30 translate duration-300" /></a>
          <a :href="`/editor/${elem.id}`" target="_blank"><SquarePen :size="64" class="p-3 shadow rounded-xl hover:bg-amber-700/30 translate duration-300" /></a>
          <a :href="`/api/quiz/editor/${elem.id}/delete`" target="_blank"><Trash2 :size="64" class="p-3 shadow rounded-xl hover:bg-amber-700/30 translate duration-300" /></a>
